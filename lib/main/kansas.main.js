...
Kansas.prototype._onConnect = function(client) {
  ...
  // bind methods
  this.create = this.tokenModel.set.bind(this.tokenModel);
  this.set = this.tokenModel.set.bind(this.tokenModel);
  this.get = this.tokenModel.get.bind(this.tokenModel);
  this.getByOwnerId = this.tokenModel.getByOwnerId.bind(this.tokenModel);
  this.del = this.tokenModel.del.bind(this.tokenModel);

  this.changePolicy = this.accountingModel.changePolicy.bind(this.accountingModel);
  this.consume = this.usageModel.consume.bind(this.usageModel);

  // policy methods
  this.policy.create = this.policy.model.set.bind(this.policy.model);
