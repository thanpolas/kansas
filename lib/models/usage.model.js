...
var Usage = module.exports = Model.extend(function() {
  ...
  this.decr = Promise.promisify(this.client.decr, {context: this.client});
  this.decrby = Promise.promisify(this.client.decrby, {context: this.client});
  this.incr = Promise.promisify(this.client.incr, {context: this.client});
  this.incrby = Promise.promisify(this.client.incrby, {context: this.client});
...
Usage.prototype._checkCountResult = Promise.method(function(key, count, consumed) {
  ...
  // At this point we know the token does not exists
