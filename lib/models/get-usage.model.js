...
var GetUsage = module.exports = Model.extend(function() {
  this.log = logger.getLogger('kansas.model.GetUsage');
...
GetUsage.prototype.getUsageActual = Promise.method(function(token, optTokenItem) {
  this.log.finer('getUsageActual() :: Init, token:', token, 'has tokenItem:',
    !!optTokenItem);
  var fetchTokenItem;
  ...
  return fetchTokenItem
    ...
    .then(function(tokenItem) {
      ...
      this.log.finest('getUsageActual() :: fetching usage key:', key);
      return key;
    })
    .then(this.get)
    .then(function(usage) {
...
GetUsage.prototype.getUsageByOwnerIdActual = Promise.method(function(ownerId) {
  this.log.finer('getUsageByOwnerIdActual() :: Init, ownerId:', ownerId);
