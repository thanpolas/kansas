...
var Token = module.exports = Model.extend(function() {
  ...
  /** @type {?kansas.model.Populate} A Populate model instance */
  this.populate = null;
});
...
/**
 * DI the populate instance to use.
 *
 * @param {kansas.model.Populate} populate The Populate instance.
 */
Token.prototype.Populate = function(populate) {
