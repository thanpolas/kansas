...
var Redis = module.exports = Model.extend(function(client, opts) {
  ...
  this.del = Promise.promisify(this.client.del, {context: this.client});
  this.hmget = Promise.promisify(this.client.hmget, {context: this.client});
  this.hgetall = Promise.promisify(this.client.hgetall, {context: this.client});
  this.exists = Promise.promisify(this.client.exists, {context: this.client});
});
